...
String [] historia ={"La Fabula de los Tres Hermanos \n Harry Potter", //0
  ...
  "Una figura encapuchada les cerró el paso.", //3
  ...
  "Despues de un tiempo de estar solo se da cuenta que extraña a sus hermanos asi que decide buscarlos", //9
...
void mousePressed() {
  ...
  //6- Pantalla HermanoDelMedio
  //-avanzar
  if (botonPressed(mouseX, mouseY, width-100, height-50, 100, 50) && estado.equals("HermanoDelMedio")) { 
    estado = "revivir";
  }

  //7-Pantalla revivir
  //Avanzar eleccion 1
  if (botonPressed(mouseX, mouseY, 500, 50, 110, 50) && estado.equals("revivir")) { 
    estado = "suicidio";
  }
  //Avanazar eleccion 2
  if (botonPressed(mouseX, mouseY, 300, 50, 170, 70) && estado.equals("revivir")) { 
    estado = "reunionHm";
  }
  ...
  //volver al inicio
   if (botonPressed(mouseX, mouseY, 250, 350, 100, 50)) { 
    if (estado.equals("finHM")||estado.equals("suicidio")){
    estado = "titulo";
  }
  }

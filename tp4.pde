...
void mousePressed() {
  ...
  //5-Pantalla regalo
  //-Avanzar
  if (botonPressed(mouseX, mouseY, width/2, 350, 100, 50) && estado.equals("regalo")) { 
    estado = "premios";
  }
  //-Volver
  ...
  if (botonPressed(mouseX, mouseY, 250, 350, 100, 50)) { 
    if (estado.equals("finHM")||estado.equals("suicidio")||estado.equals("finCompartido")) {
      estado = "titulo";
    }
  }

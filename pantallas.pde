...
void introduccion() {
  ...
  botonDibujado(50, height-100, 100, 50);
  botonDibujado(width-150, height-100, 100, 50);
  textSize(25);
  textAlign(CENTER);
  fill(0);
...
void muerte() {
  ...
  botonDibujado((width/2)-50, 330, 100, 50);
  textSize(25);
  textAlign(CENTER);
  fill(255);
...
void premios() {
  ...
  botontxt(50, 300, 100, 50, "Hermano\n del medio");
  botontxt(width-150, 300, 100, 50,"Hermano\n Menor");
  botontxt(width/2, 300, 100, 50,"Hermano\n Mayor");

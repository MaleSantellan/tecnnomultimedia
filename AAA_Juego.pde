//Clase Principal
class Juego {
  //nombre de la Clase, instancia del objeto
  Hmen h;
  Muerte m;
  Capa c;
  Varita v;
  ...
  Pantalla pant ;
  Boton empezar;
  //Pantalla p, pantallaInicio, pantallaInstrucciones, pantallaPerdiste, pantallaGanaste;
  ...
  String estado;
  boolean gano; 
  //pantalla0=inicio, pantalla1= perdiste, pantalla2= ganaste;
  ...
  //______________________________Mover Hermano Menor
  void moverPersonaje(int tecla) {
    h.moverHmen(tecla);
  }

  //______________________________Colisiones 
  void encuentromyh() {
